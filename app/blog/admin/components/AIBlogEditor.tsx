                  ...
                  <div className="mt-4 space-y-4">
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
                      ...
                      <div className="text-xs text-gray-600 space-y-2">
                        <div><strong>Corporate Tech:</strong> &quot;Vibeblogger brand: Professional blue and white color scheme, clean minimal design inspired by IBM and Apple. Abstract geometric elements, data visualization style, corporate presentation quality.&quot;</div>
