...
export default function TimelineCrimson() {
      ...
      <div className="min-h-screen bg-white">
        ...
        <header className="border-b border-gray-200">
          <div className="max-w-5xl mx-auto px-6 py-6 flex items-center justify-between">
            <div className="flex items-center gap-6">
              ...
              <span className="text-xl font-mono text-gray-900 tracking-tight">
                Rori&apos;s Schedule
              </span>
          ...
          <div className="space-y-6">
            {mockBlocks.map((block, index) => (
              ...
              >
                ...
                {/* Block title - Crimson Text serif */}
                <h2
        ...
        <div className="fixed bottom-4 right-4 bg-white border border-gray-200 px-4 py-2 shadow-lg rounded">
          <p className="text-xs font-mono text-gray-900">
            <strong>Font: Crimson Text</strong>
          </p>
          <p className="text-xs text-gray-500 mt-1">Literary, sophisticated</p>
          <div className="mt-2 pt-2 border-t border-gray-200 space-y-1">
            <Link href="/timeline-blog-draft" className="block text-xs text-gray-500 hover:text-gray-900">
              Georgia (original)
            </Link>
            <Link href="/timeline-lora" className="block text-xs text-gray-500 hover:text-gray-900">
              Lora
            </Link>
