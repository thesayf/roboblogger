...
export default function InventoryNoHeader() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        {/* Inventory content - no header */}
        <div className="max-w-5xl mx-auto px-6 py-8">
          <div className="space-y-8">
            {/* User Context Section with name */}
            <section
            ...
            >
              <div className="mb-4">
                <h1 className="text-2xl mb-2" style={{ fontFamily: "Lora, Georgia, serif", color: "#171717" }}>
                  Rori's Inventory
                </h1>
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-mono text-gray-900">GOALS 5</h2>
              </div>
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-mono text-gray-900">PROJECTS 6</h2>
              </div>
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-mono text-gray-900">ROUTINES 5</h2>
              </div>
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-mono text-gray-900">ADMIN TASKS 3</h2>
              </div>
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-mono text-gray-900">EVENTS 2</h2>
              </div>
        ...
        <div className="fixed bottom-4 left-4 bg-white border border-gray-200 px-4 py-3 shadow-lg rounded max-w-xs">
          <p className="text-xs font-mono text-gray-900 mb-2">
            <strong>No Header Version</strong>
          </p>
          <ul className="text-xs text-gray-600 space-y-1">
            <li>• No header/toolbar</li>
            <li>• Name in first section</li>
            <li>• More content-focused</li>
          </ul>
          <div className="mt-3 pt-3 border-t border-gray-200">
            <Link href="/inventory-redesign" className="text-xs text-blue-600 hover:text-blue-800">
              ← Back to version with header
            </Link>
          </div>
        </div>
      </div>
