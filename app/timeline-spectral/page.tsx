...
export default function TimelineSpectral() {
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="fixed bottom-4 right-4 bg-white border border-gray-200 px-4 py-2 shadow-lg rounded">
          <p className="text-xs font-mono text-gray-900">
            <strong>Font: Spectral</strong>
          </p>
          <p className="text-xs text-gray-500 mt-1">Modern, clean, minimal</p>
